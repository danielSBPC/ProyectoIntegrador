...
public class PrincipalUsu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jpLateral.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 20, 110, 110));
        ...
        jpLateral.add(boton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 230, 60));
        ...
        boton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icoMusc.png"))); // NOI18N
        boton2.setText("Musculación");
        boton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                boton2ActionPerformed(evt);
            }
        });
        jpLateral.add(boton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 230, 60));
        ...
        jpLateral.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 140, 110, 30));
        ...
        jpCabecera.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
    ...
    private void boton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton1ActionPerformed
        ...
        u1.cargarTablaEjercicio(gimPersi.consultaEjercicioPorTipo("Cardio"));
    ...
    private void boton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton2ActionPerformed
        ...
        u1.cargarTablaEjercicio(gimPersi.consultaEjercicioPorTipo("Musculación"));
